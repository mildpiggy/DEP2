             ...
             column(width = 5,
                    tabBox(title = "Result Plots", width = 12,
                           tabPanel(title = "Bar plot",
                                    ...
                                    shinyBS::bsTooltip(ns("go_Select_bar"), "Display the selected genesets in res table or top genesets(ordered by p)", "top", options = list(container = "body")),
                           ...
                           tabPanel(title = "Dot plot",
                                    ...
                                    shinyBS::bsTooltip(ns("go_Select_dot"), "Display the selected genesets in res table or top genesets(ordered by p)", "top", options = list(container = "body")),
                           ...
                           tabPanel(title = "Dot opt",
                                    ...
                                    shinyBS::bsTooltip(ns("go_Select_dot_opt"), "Display the selected genesets in res table or top genesets(ordered by p)", "top", options = list(container = "body")),
                           ...
                           tabPanel(title = "Heatplot",
                                    ...
                                    shinyBS::bsTooltip(ns("go_Select_heat"), "Display the selected genesets in res table or top genesets(ordered by p)", "top", options = list(container = "body")),
                           ...
                           tabPanel(title = "Cnetplot",
                                    ...
                                    shinyBS::bsTooltip(ns("go_Select_cnet"), "Display the selected genesets in res table or top genesets(ordered by p)", "top", options = list(container = "body")),
                           ...
                           tabPanel(title = "Emaplot",
                                    ...
                                    shinyBS::bsTooltip(ns("go_Select_ema"), "Display the selected genesets in res table or top genesets(ordered by p)", "top", options = list(container = "body")),
...
ORA_GO_server_module <- function(id, gene_df, gene_id, organism_for_ORA, annoSpecies_df) {
  moduleServer(
    id = id,
    function(input, output, session) {
      ...
      output$Table <- DT::renderDataTable({
        # if(!input$import_from_existed_analysis_for_ORA) {
        #   shiny::validate(
      ...
      go_barplot_input <- reactive({
        ...
        if(input$go_Select_bar){
          ...
          res <- res()$sig_res %>% filter(.,1:nrow(.) %in% input$Table_rows_selected)
        }else{
          res <- res()$sig_res
        }
...
#* other submodule UI/Server in ORA module ----
  ...
  moduleServer(
    ...
    function(input, output, session,id=id) {
      ...
      barplot_input <- reactive({
        ...
        on.exit(progress$close())
        barplot(res, showCategory = input$ShowCategory_bar, color = input$color)
      })
      ...
      dotplot_input <- reactive({
        ...
        # Close the progress when this reactive exits (even if there's an error)
        on.exit(progress$close())
        dotplot(res, showCategory = input$ShowCategory_dot, color = input$color)
      })
