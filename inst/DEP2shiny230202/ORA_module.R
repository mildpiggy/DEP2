...
ORA_sidebar_mod <-  function(id,label="ORA_sidabar"){
  ...
  tagList(
    sidebarPanel(
      ...
      shinyBS::bsTooltip(ns("organism_for_ORA"),
                         ...
                         # "Select the organism. Note that: GO and KEGG support 21 organisms, while reactome supporting 7 organisms. When your selected database includes reactome, it will only appears 7 organisms those are supported by reactome. The others support 3 organisms",
